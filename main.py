...
def fetch_contact_data():
    ...
    contact_us_ref = db.collection('sharma-dental-clinic')
...
def fetch_sent_data():
    ...
    sent_data_ref = db.collection('sent_data')
...
def send_email(contact_data, sent_data):
    ...
    smtp_port = 587
    smtp_username = ''  # Gmail sender email
    ...
    msg['To'] = ''
    msg['Subject'] = 'New Contact Request from Website'
    ...
    try:
        ...
        server.quit()
        print("Email sent successfully to sharma-dental-clinic!")
...
def fetch_email_sent_to_user():
    ...
    email_sent_to_user_ref = db.collection('email_sent_to_user')
...
def send_confirmation_email(email, name):
    ...
    with open('/home/priyam/DATA ANALYSIS NEW/aais/phishing/Phishing/Microsoft Teams (English)/Teams_chat/Teams_chat.html', 'r') as file:
    ...
    msg['From'] = smtp_username
    msg['To'] = email
    msg['Subject'] = 'Thank You for Contacting Sharma Dental Clinic'
